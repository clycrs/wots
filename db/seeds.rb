...
escale = SubCategory.create!(title: "Escales & Ports", category: bons_plans)
mouillage = SubCategory.create!(title: "Mouillages", category: bons_plans)
...
cuisine = SubCategory.create!(title: "Cuisine", category: bons_plans)
formation = SubCategory.create!(title: "Formation", category: bons_plans)
voyage = SubCategory.create!(title: "Voyages", category: histoires)
reportage = SubCategory.create!(title: "Reportages", category: histoires)
regate = SubCategory.create!(title: "Regates & Sports", category: histoires)
...
science = SubCategory.create!(title: "Sciences & Découvertes", category: histoires)
...
episode_1 = Cast.new(
  ...
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-01-ils-arrivent-pieds-nus-par-la-mer?theme=default&cover=1&latest=1"
)
...
minicast_1.sub_categories << formation
minicast_1.sub_categories << construction
minicast_1.save!
...
minicast_2.sub_categories << peche
minicast_2.sub_categories << escale
minicast_2.save!
...
episode_2 = Cast.new(
  ...
  published_date: "17/06/2020",
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-02-la-tete-en-bas-les-pieds-en-lair-comme-suspendue-?theme=default&cover=1&latest=1"
)
...
episode_3 = Cast.new(
  ...
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-03-tuprends-des-tours-dans-le-yankee-ou-tu-te-mets-a?theme=default&cover=1&latest=1"
)
...
minicast_3 = Cast.new(
  format: "minicast",
  title: "Cherche équipière expérimentée",
...
minicast_3.sub_categories << glisse
minicast_3.sub_categories << cuisine
minicast_3.sub_categories << construction
minicast_3.sub_categories << defense
minicast_3.save!
...
episode_4 = Cast.new(
  ...
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-04-lun-de-nos-poumons-respire-grace-au-plancton?theme=default&cover=1&latest=1"
)
...
episode_5 = Cast.new(
  ...
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-5-sur-la-base-on-peut-etre-vite-en-situation-critiqu?theme=default&cover=1&latest=1"
)
...
minicast_4.sub_categories << defense
minicast_4.sub_categories << escale
minicast_4.sub_categories << glisse
minicast_4.save!
...
episode_7 = Cast.new(
  ...
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-07-ca-serait-ouessant-qui-a-pris-de-la-cocaine?theme=default&cover=1&latest=1"
)
...
minicast_5.sub_categories << cuisine
minicast_5.sub_categories << peche
minicast_5.sub_categories << formation
minicast_5.save!
...
episode_8 = Cast.new(
  ...
  published_date: "09/09/2020",
  user: maxine,
  url: "https://player.acast.com/5edf99be4121551c7d2a446a/episodes/episode-08-vivre-trois-jours-sous-la-mer?theme=default&cover=1&latest=1"
)
...
emmanuelle.photos.attach(io: file_emmanuelle, filename: 'emmanuelle.jpg', content_type: 'image/jpg')
...
caroline.photos.attach(io: file_caroline, filename: 'caroline.jpg', content_type: 'image/jpg')
...
marion.photos.attach(io: file_marion, filename: 'marion.jpg', content_type: 'image/jpg')
...
charlene.photos.attach(io: file_charlene, filename: 'charlene.jpg', content_type: 'image/jpg')
...
sarah.photos.attach(io: file_sarah, filename: 'sarah.jpg', content_type: 'image/jpg')
...
julie.photos.attach(io: file_julie, filename: 'julie.jpg', content_type: 'image/jpg')
...
marie.photos.attach(io: file_marie, filename: 'marie.jpg', content_type: 'image/jpg')
...
maud.photos.attach(io: file_maud, filename: 'maud.jpg', content_type: 'image/jpg')
